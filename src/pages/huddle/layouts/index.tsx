export { Header } from '@/pages/huddle/layouts/Header.layout';
export { PrimaryNavigation } from '@/pages/huddle/layouts/PrimaryNavigation.layout';
export { Hero } from '@/pages/huddle/layouts/Hero.layout';
export { Main } from '@/pages/huddle/layouts/Main.layout';
